...
The _master_ branch holds the latest stable build of the project. The _develop_ branch holds our latest development builds.

- - -  

### Waffle and Git workflow automation
For every ticket item (work item), we create a fresh branch off of _develop_, make our changes, get it reviewed, and integrate it back into the development branch. This branching allows us sandboxes without too much fear of destroying all the working things! (:
